...
const DATA = {
  ...
  augustin2025: {
    ...
    divers: [
      { mois: "Février", montant: 400, label: "Vol pour Augustin", preuve: "ok", preuveText: "✓ EBS" },
      { mois: "Juin", montant: 1240, label: "Vol pour Augustin", preuve: "ok", preuveText: "✓ EBS" },
      { mois: "Septembre", montant: 1130, label: "iPhone 1 305,41 USD", preuve: "ok", preuveText: "✓ EBS 09/10" },
      { mois: "Novembre", montant: 700, label: "Virement instantané (12/11)", preuve: "ok", preuveText: "✓ EBS" },
      { mois: "Novembre", montant: 500, label: "Virement instantané (18/11)", preuve: "ok", preuveText: "✓ EBS" },
      { mois: "Novembre", montant: 600, label: "Virement instantané (09/11, Seq.1229)", preuve: "ok", preuveText: "✓ EBS" },
      { mois: "Novembre", montant: -1500, label: "Prêt (15/12, Seq.1404)", preuve: "ok", preuveText: "✓ EBS" },
      { mois: "Décembre", montant: 600, label: "Virement instantané (08/12, Seq.1373)", preuve: "ok", preuveText: "✓ EBS" },
      { mois: "Décembre", montant: -2500, label: "Prêt (04/12, Seq.1362)", preuve: "ok", preuveText: "✓ EBS" },
    ],
    diversVerifie: 9170,
    diversNonVerifie: 0,
